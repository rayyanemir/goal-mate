...
from main.views import add_product_ajax, edit_product_ajax, delete_product_ajax, get_product_json,login_ajax,proxy_image,my_products_flutter
...
urlpatterns = [
    ...
    path('create-product-ajax/', add_product_ajax, name='add_product_ajax'), #tambahan mulai dari sini
    ...
    path('my-products/', my_products_flutter, name='my_products_flutter'),
]